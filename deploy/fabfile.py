...
# path on server
DEPLOY_DIR = '/var/www'
PROJECT_DIR = os.path.join(DEPLOY_DIR, 'terrorism_rear_end')
...
# path on local
PROJECT_LOCAL_DIR = 'D:/python/terrorism_rear_end'

GITHUB_PATH = 'https://github.com/LaZzyMan/terrorism_rear_end'
